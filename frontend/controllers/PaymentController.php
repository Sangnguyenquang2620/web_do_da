...
//          unset($_SESSION['cart']);
          ...
          if ($method == 1) {
            ...
            print_r($body);
            echo "</pre>";
              $_SESSION['success'] = 'Thanh toán thành công. Chúng tôi sẽ giao hàng cho quý khách sớm nhất trong thời gian tới. King of Sneaker xin chân thành cảm ơn quý khách !!!';
              header("Location: index.php");
              exit();
